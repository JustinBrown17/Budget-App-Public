...
def main():
    ...
    while True:
        try:
            FIRST_PAY_DATE = datetime.strptime(input("What was your first pay date? Use YYYY-MM-DD format "), "%Y-%m-%d")
            break
        except ValueError:
    ...
    print('{}{}'.format('First months pay = ', FIRST_PAY_DATE.month))
    print('{}{}'.format('Remaining months to average pay = ', remaining_months_of_pay))
    print('{}{}{}{}'.format('Your first pay was: #', firstPayNum, ' out of #', PAY_FREQUENCY))
    print('{}{}{}{}'.format('Total # of pays received in ', FIRST_PAY_DATE.year, ': ', total_pays_of_year))
